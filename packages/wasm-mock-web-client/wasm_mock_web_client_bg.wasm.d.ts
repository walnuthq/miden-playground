...
export const foreignaccount_public: (
  a: number,
  b: number,
...
export const transactionprover_newRemoteProver: (
  a: number,
  b: number,
) => number;
export const transactionprover_serialize: (a: number) => [number, number];
export const transactionprover_deserialize: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const secretkey_withRng: (
  a: number,
  b: number,
) => [number, number, number];
...
export const noteexecutionhint_onBlockSlot: (
  a: number,
  b: number,
  c: number,
) => number;
...
export const __wbg_transactionrequestbuilder_free: (
  a: number,
  b: number,
) => void;
export const transactionrequestbuilder_new: () => number;
export const transactionrequestbuilder_withUnauthenticatedInputNotes: (
  a: number,
  b: number,
) => number;
export const transactionrequestbuilder_withAuthenticatedInputNotes: (
  a: number,
  b: number,
) => number;
export const transactionrequestbuilder_withOwnOutputNotes: (
  a: number,
  b: number,
) => number;
export const transactionrequestbuilder_withCustomScript: (
  a: number,
  b: number,
) => number;
export const transactionrequestbuilder_withExpectedOutputRecipients: (
  a: number,
  b: number,
) => number;
export const transactionrequestbuilder_withExpectedFutureNotes: (
  a: number,
  b: number,
) => number;
export const transactionrequestbuilder_extendAdviceMap: (
  a: number,
  b: number,
) => number;
export const transactionrequestbuilder_withForeignAccounts: (
  a: number,
  b: number,
  c: number,
) => number;
...
export const transactionrequest_deserialize: (
  a: any,
) => [number, number, number];
export const transactionrequest_expectedOutputOwnNotes: (
  a: number,
) => [number, number, number, number];
export const transactionrequest_expectedFutureNotes: (
  a: number,
) => [number, number, number, number];
export const __wbg_transactionscript_free: (a: number, b: number) => void;
export const transactionscript_root: (a: number) => number;
export const transactionscript_compile: (
  a: number,
  b: number,
  c: number,
) => [number, number, number];
...
export const webclient_submitTransaction: (
  a: number,
  b: number,
  c: number,
) => any;
export const webclient_newMintTransactionRequest: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const webclient_newSendTransactionRequest: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const webclient_newConsumeTransactionRequest: (
  a: number,
  b: number,
  c: number,
) => [number, number, number];
export const webclient_newSwapTransactionRequest: (
  a: number,
  b: number,
  c: number,
  d: bigint,
...
export const webclient_compileNoteScript: (
  a: number,
  b: number,
  c: number,
) => [number, number, number];
...
export const webclient_buildSwapTag: (
  a: number,
  b: number,
  c: bigint,
  d: number,
...
export const webclient_compileTxScript: (
  a: number,
  b: number,
  c: number,
) => [number, number, number];
...
export const accountbuilder_new: (
  a: number,
  b: number,
) => [number, number, number];
...
export const transactionrecord_inputNoteNullifiers: (
  a: number,
) => [number, number];
...
export const transactionrecord_deserialize: (
  a: any,
) => [number, number, number];
...
export const transactionresult_deserialize: (
  a: any,
) => [number, number, number];
...
export const note_createP2IDNote: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const note_createP2IDENote: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const notetag_forPublicUseCase: (
  a: number,
  b: number,
  c: number,
) => number;
...
export const webclient_createClient: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const webclient_importPublicAccountFromSeed: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const merklepath_computeRoot: (
  a: number,
  b: bigint,
  c: number,
) => number;
export const merklepath_verify: (
  a: number,
  b: bigint,
  c: number,
  d: number,
...
export const __wbg_transactionscriptinputpair_free: (
  a: number,
  b: number,
) => void;
export const transactionscriptinputpair_new: (
  a: number,
  b: number,
  c: number,
) => number;
export const transactionscriptinputpair_felts: (a: number) => [number, number];
export const __wbg_transactionscriptinputpairarray_free: (
  a: number,
  b: number,
) => void;
export const transactionscriptinputpairarray_new: (
  a: number,
  b: number,
) => number;
export const transactionscriptinputpairarray_push: (
  a: number,
  b: number,
) => void;
...
export const webclient_newWallet: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const webclient_newFaucet: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const webclient_newAccount: (
  a: number,
  b: number,
  c: number,
  d: number,
) => any;
export const webclient_addAccountSecretKeyToWebStore: (
  a: number,
  b: number,
) => any;
...
export const accountcomponent_compile: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const accountcomponent_getProcedureHash: (
  a: number,
  b: number,
  c: number,
) => [number, number, number, number];
...
export const accountid_toBech32: (
  a: number,
  b: number,
) => [number, number, number, number];
export const accountid_toBech32Custom: (
  a: number,
  b: number,
  c: number,
) => [number, number, number, number];
...
export const consumablenoterecord_new: (
  a: number,
  b: number,
  c: number,
) => number;
export const consumablenoterecord_inputNoteRecord: (a: number) => number;
export const consumablenoterecord_noteConsumability: (
  a: number,
) => [number, number];
...
export const inputnoterecord_consumerTransactionId: (
  a: number,
) => [number, number];
...
export const assemblerutils_createAccountComponentLibrary: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const authsecretkey_getRpoFalcon512PublicKeyAsWord: (
  a: number,
) => number;
export const authsecretkey_getRpoFalcon512SecretKeyAsFelts: (
  a: number,
) => [number, number];
...
export const webclient_exportNote: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const closure2288_externref_shim: (a: number, b: number, c: any) => void;
export const closure2310_externref_shim: (
  a: number,
  b: number,
  c: any,
  d: any,
