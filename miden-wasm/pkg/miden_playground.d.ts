...
export class NoteData {
  free(): void;
  constructor(assets: (AssetData)[], inputs: BigUint64Array, script: string, sender_id: string, sender_script: string, serial_number: BigUint64Array);
...
export interface InitOutput {
  ...
  readonly notedata_new: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number) => number;
