...
export const generate_note_tag: (a: number, b: number) => [number, number, number];
...
export const accountdata_new: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: bigint) => [number, number, number];
...
export const notedata_new: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: bigint, o: number, p: number) => number;
...
export const notedata_tag: (a: number) => number;
export const notedata_aux: (a: number) => bigint;
export const notedata_recipient_digest: (a: number) => [number, number, number, number];
