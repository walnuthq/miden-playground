...
export const generate_account_id: (a: number, b: number) => [bigint, number, number];
export const generate_faucet_id: (a: number, b: number) => [bigint, number, number];
...
export const create_swap_note: (a: number, b: number, c: bigint, d: bigint, e: number) => [number, number, number];
