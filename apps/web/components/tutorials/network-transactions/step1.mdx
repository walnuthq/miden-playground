...
We'll build a network counter smart contract using the same code as the regular counter, but with a different [authentication component](https://docs.miden.xyz/reference/protocol/account/code#authentication) to enable network execution.
