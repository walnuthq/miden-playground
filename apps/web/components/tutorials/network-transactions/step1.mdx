...
We'll build a network counter smart contract using the same code as the regular counter, but with different [storage configuration](https://docs.miden.xyz/reference/protocol/account/id#account-storage-mode) to enable network execution.
