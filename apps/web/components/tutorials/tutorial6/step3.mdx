...
[Account components](https://docs.miden.xyz/design/miden-base/account/components/) are the building blocks that define an account's [code](https://docs.miden.xyz/design/miden-base/account/code/) and [storage](https://docs.miden.xyz/design/miden-base/account/storage/).
