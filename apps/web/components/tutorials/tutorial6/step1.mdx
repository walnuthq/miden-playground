...
When creating a note, you can pass arbitrary parameters called [Note Inputs](https://docs.miden.xyz/miden-base/note#inputs) and the [Note Script](https://docs.miden.xyz/miden-base/note#script) can access these inputs.
