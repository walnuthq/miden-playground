...
Let's get started by clicking on _"Create new script"_ then choose a name and make sure to select an **Account Component** script using the **Counter Contract** example.
