...
It must have the following implementation:
...
Don't forget to also declare the procedure signature in the **`CounterContract`** trait:
...
When developing a smart contract you write human-readable Rust code and use a compiler to transpile it to [MASM](https://docs.miden.xyz/builder/glossary/#miden-assembly) code that can be executed by the [MidenVM](https://docs.miden.xyz/design/miden-vm/).
