...
Our newly created Account generated its own unique [Account ID](https://docs.miden.xyz/core-concepts/protocol/account/id), an immutable and unique identifier for the Account. Click on the link below to access your wallet:

<AccountAddress account={props.wallet} />
...
- **Faucets**: Faucets are always immutable and can be specialized by the type of [Assets](https://docs.miden.xyz/core-concepts/protocol/asset) they issue: either fungible or non-fungible.
