...
Our newly created Account generated its own unique [Account ID](https://0xmiden.github.io/miden-docs/imported/miden-base/src/account.html#id), an immutable and unique identifier for the Account. Click on the link below to access your wallet:
