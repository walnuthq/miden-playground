...
Our newly created Account generated its own unique [Account ID](https://docs.miden.xyz/design/miden-base/account/id/), an immutable and unique identifier for the Account. Click on the link below to access your wallet:
...
- **Faucets**: Faucets are always immutable and can be specialized by the type of [Assets](https://docs.miden.xyz/design/miden-base/asset/) they issue: either fungible or non-fungible.
