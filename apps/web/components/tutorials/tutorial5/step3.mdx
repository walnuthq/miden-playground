...
- Calls **active_account::get_item** with the index of 0.
- Calls **sys::truncate_stack** to truncate the stack to size 16.
- The value returned from **active_account::get_item** is still on the stack and will be returned when this procedure is called.
...
- Adds 1 to the count value returned from **active_account::get_item**.
...
- Calls **native_account::set_item** which saves the incremented count to storage at index 0
- Calls **sys::truncate_stack** to truncate the stack to size 16.
