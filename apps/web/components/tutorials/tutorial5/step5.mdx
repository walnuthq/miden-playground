...
Now that we both defined our [AccountCode](https://docs.miden.xyz/miden-base/account/code) using a script and [AccountStorage](https://docs.miden.xyz/miden-base/account/storage) using an account component, it's time to deploy our contract on testnet.
