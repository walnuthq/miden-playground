...
When creating a note, you can pass arbitrary parameters called [Note Storage](https://docs.miden.xyz/reference/protocol/note#storage) and the [Note Script](https://docs.miden.xyz/reference/protocol/note#script) can access these storage items.
