...
When creating a note, you can pass arbitrary parameters called [Note Storage](https://docs.miden.xyz/core-concepts/protocol/note#storage) and the [Note Script](https://docs.miden.xyz/core-concepts/protocol/note#script) can access these storage items.

In our timelock example, we have 2 note storage items: the recipient account ID and the minimal block height before the note can be consumed.
