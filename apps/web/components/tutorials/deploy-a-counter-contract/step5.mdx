...
Now that we both defined our [AccountCode](https://docs.miden.xyz/reference/protocol/account/code) using a script and [AccountStorage](https://docs.miden.xyz/reference/protocol/account/storage) using an account component, it's time to deploy our contract on testnet.
...
When you're done configuring your contract deployment, click on the _"Deploy"_ button to create your account: it will take some time as the process also funds it and wait until the new account is acknowledged by testnet.
