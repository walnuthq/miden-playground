...
[Account components](https://docs.miden.xyz/reference/protocol/account/components) are the building blocks that define an account's [code](https://docs.miden.xyz/reference/protocol/account/code) and [storage](https://docs.miden.xyz/reference/protocol/account/storage).
